        ...
        {     
            ...
            else switch(id->type)
            {
                ...
                {   
                    ...
                    {
                        case 's':                                 v[n] = w[++wn];      break;
                        case 'i': nstor[n].i = parseint(w[++wn]); v[n] = &nstor[n].i;  break;
                        case 'f': nstor[n].f = atof(w[++wn]);     v[n] = &nstor[n].f;  break;
                        case 'V': v[n++] = w+1; nstor[n].i = numargs-1; v[n] = &nstor[n].i;  break;
                        case 'C': if(!cargs) cargs = conc(w+1, numargs-1, true); v[n] = cargs; break; // all args
                        case 'R': if(!cargs) cargs = conc(w+1+n, numargs-1-n, true); v[n] = cargs; break; // rest of args
