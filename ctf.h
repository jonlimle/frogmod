...
#ifdef SERVMODE
    void addflag(int i, const vec &o, int team, int64_t invistime = 0)
#else
    void addflag(int i, const vec &o, int team, int64_t vistime = -1000)
#endif
    {
...
#ifdef SERVMODE
    static const int64_t RESETFLAGTIME = 10000;
    static const int64_t INVISFLAGTIME = 20000;
